...
function App() {
  return (
    <>
      <div className="hero grid md:grid-cols-2 pt-10 items-center xl:gap-0 gap-6 grid-cols-1">
        <div>
          ...
          <h1 className="text-2xl/tight font-bold mb-6 ">
            Halo, Saya <span className="text-blue-500">Ari Zainal Fauziah</span>
          </h1>
          <p className="text-base/loose mb-6">
            Lulusan D3 Sistem Informasi Universitas Bina Sarana Informatika
            yang kini mendalami bidang <span className="text-blue-500">Fullstack Developer</span>. Memiliki pemahaman dasar yang kuat dalam jaringan
          ...
          <div className="flex items-center sm:gap-4 gap-2 ">
            <a href="#" className="bg-red-600 hover:text-red-600 text-white p-4 rounded-lg hover:bg-zinc-800 transition">
              Download CV <i className="ri-download-line ri-lg"></i>
            </a>
            <a href="#" className="bg-zinc-600 text-white p-4 rounded-lg hover:bg-zinc-800 transition">
        ...
        <div className="flex flex-col relative sm:w-[400px] md:ml-auto hover:scale-105 transition-transform duration-300">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 -bottom-10 p-4 bg-zinc-800 rounded-lg flex items-center gap-3 shadow-lg social-icons">
            <a href="#" className="hover:bg-red-600 text-red-600 hover:text-white p-4 rounded-lg hover:bg-red-800 transition">
      ...
      <div className="tentang mt-32 py-6 rounded-2xl">
            ...
            <div className="lg:w-3/5 w-full">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 md:gap-10">
                <div className="text-center bg-zinc-900 p-4 rounded-xl shadow-md w-full sm:w-auto hover:scale-105 transition-transform duration-300">
                  <h1 className="text-3xl md:text-4xl font-bold mb-1 text-white stat-number">20 <span className="text-red-500">+</span></h1>
                  <p>Proyek Selesai</p>
                </div>
                <div className="text-center bg-zinc-900 p-4 rounded-xl shadow-md w-full sm:w-auto hover:scale-105 transition-transform duration-300">
                  <h1 className="text-3xl md:text-4xl font-bold mb-1 text-white stat-number">1 <span className="text-red-500">+</span></h1>
      ...
      <div className="portofolio grid md:grid-cols-2 lg:grid-cols-3 pt-4 items-center xl:gap-4 gap-6 grid-cols-1">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-10 md:gap-12">
            ...
            <div className="lg:w-2/5 w-full">
              ...
              <address className="flex flex-col gap-4 not-italic">
                <div className="flex items-center gap-4 p-4 bg-zinc-900 rounded-lg">
                  <i className="ri-map-pin-line ri-2x text-red-500"></i>
                  <div>
                ...
                <a href="mailto:arizainalf@gmail.com" className="flex items-center gap-4 p-4 bg-zinc-900 rounded-lg hover:bg-zinc-700 transition-colors">
                  <i className="ri-mail-send-line ri-2x text-red-500"></i>
                  <div>
                ...
                <a href="https://wa.me/6281930865458" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 bg-zinc-900 rounded-lg hover:bg-zinc-700 transition-colors">
                  <i className="ri-whatsapp-line ri-2x text-red-500"></i>
                  <div>
            ...
            <div className="lg:w-3/5 w-full">
              ...
              <form action="#" method="POST" className="flex flex-col gap-5">
                <div>
                  <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-300">Nama Anda</label>
                  <input type="text" id="name" name="name" className="w-full p-3 bg-zinc-700 border border-zinc-600 rounded-lg text-white focus:ring-red-500 focus:border-red-500" placeholder="John Doe" required />
                </div>
                <div>
                  <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-300">Email Anda</label>
                  <input type="email" id="email" name="email" className="w-full p-3 bg-zinc-700 border border-zinc-600 rounded-lg text-white focus:ring-red-500 focus:border-red-500" placeholder="name@example.com" required />
                </div>
                <div>
                  <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-300">Pesan</label>
                  <textarea id="message" name="message" rows="4" className="w-full p-3 bg-zinc-700 border border-zinc-600 rounded-lg text-white focus:ring-red-500 focus:border-red-500" placeholder="Tuliskan pesan Anda di sini..."></textarea>
                </div>
                <button type="submit" className="bg-red-600 text-white font-bold py-3 px-5 rounded-lg hover:bg-red-700 transition-colors w-full sm:w-auto">
                  Kirim Pesan
                </button>
              </form>
            </div>
